...
ethProof.getTxProof('0xb53f752216120e8cbe18783f41c6d960254ad59fac16229d4eaec5f7591319de', function(e,r){
  // EthVerify._tx()
  x = r; err = e
  console.log("proof =>", EthVerify.tx(x.path, x.tx, x.stack, x.header, x.blockhash))
})
