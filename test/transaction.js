...
describe('getTransactionProof', function () {
  ...
  //     console.log("THINGS ",EP.transaction(result.path, result.value, result.parentNodes, result.header, result.blockHash))
  ...
  it('should be able to request a proof from web3 and verify it', function (done) {
    ...
    // eP.getAccountProof('0xc1cdc601f89c0428b31302d187e0dc08ad7d1c57').then((result)=>{
    //   console.log("HERER")
    //   console.log("OLD ", EP.account(result.address, result.value, result.parentNodes, result.header, result.blockHash))
    //   done()
    // }).catch((e) => {console.log(e)})
    // // eP.transaction(thing)
