...
describe('Mainnet getTransactionProof', () => {
...
it('should be able to request a proof for ', async () => {
  ...
  it('requesting invalid tx hash should throw error', async () => {
    let blockHash = '0xc32470c2459fd607246412e23b4b4d19781c1fa24a603d47a5bc066be3b5c0af'    
    await buildProof.txAgainstBlockHash("0x1234", blockHash).should.be.rejectedWith(Error)
    await buildProof.txAgainstBlockHash("0x1111111111222222222233333333334444444444555555555566666666667777", blockHash).should.be.rejectedWith(Error)
  });
  ...
  it('should throw when attempting to prove against the wrong blockHash', async () => {
    ...
    await buildProof.txAgainstBlockHash(txFromBlockNum1008398, blockHashFromBlockNum4012371).should.be.rejectedWith(Error)
    // console.log("TX ", tx)
  });
