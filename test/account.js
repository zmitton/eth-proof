...
describe('account proofs', () => {
  ...
  it('can verify proof', async () => {
    let prf = await buildProof.getAccountProof("0xc1cdc601f89c0428b31302d187e0dc08ad7d1c57", "0x0")
    // console.log("PRF", prf)
  ...
  it('can verify proof', async () => {
    let prf = await buildProof.getAccountProof("0x9cc9bf39a84998089050a90087e597c26758685d")
