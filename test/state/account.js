...
describe('account state proof/verify full account [nonce, balance, storageRoot, codeHash]', function () {
  ...
  it('can request a contract proof from local chaindata', function (done) {
    eP.getAccountProof('9cc9bf39a84998089050a90087e597c26758685d').then((result)=>{
      EP.account(result.address, result.value, result.stack, result.header, result.blockhash).should.be.true()
      done()
  ...
  it('can request a proof from local chaindata', function (done) {
    eP.getAccountProof('0x4914025aa9ea9f274b174205adde3243eec74589bef9a0e78a433763b2f8caa3').then((result)=>{
      EP.account(result.path, result.value, result.stack, result.header, result.blockhash).should.be.true()
...
describe('account nonce proof/verify', function () {
  ...
  it('can request a contract proof from local chaindata', function (done) {
    eP.getNonceProof('9cc9bf39a84998089050a90087e597c26758685d').then((result)=>{
      EP.accountNonce(result.address, result.value, result.stack, result.header, result.blockhash).should.be.true()
      done()
    }).catch((e) => {console.log(e)})
  });
...
describe('account state: ETH balance proofs', function () {
  ...
  it('can request a contract proof from local chaindata', function (done) {
    eP.getBalanceProof('9cc9bf39a84998089050a90087e597c26758685d').then((result)=>{
      EP.balance(result.address, result.value, result.stack, result.header, result.blockhash).should.be.true()
      done()
    }).catch((e) => {console.log(e)})
  });
  ...
  it('can request a proof from local chaindata', function (done) {
    eP.getBalanceProof('0x4914025aa9ea9f274b174205adde3243eec74589bef9a0e78a433763b2f8caa3').then((result)=>{
      EP.balance(result.path, result.value, result.stack, result.header, result.blockhash).should.be.true()
      new Error("not a tx. `get` should fail")
      (false).should.be.true("not a tx. `get` should fail")
      done()
    }).catch((e)=>{
...
describe('account state: storageRoot proofs', function () {
  ...
  it('can request a contract proof from local chaindata', function (done) {
    eP.getStorageRootProof('9cc9bf39a84998089050a90087e597c26758685d').then((result)=>{
      EP.storageRoot(result.address, result.value, result.stack, result.header, result.blockhash).should.be.true()
      done()
    }).catch((e) => {console.log(e)})
  });
  ...
  it('can request a proof from local chaindata', function (done) {
    eP.getStorageRootProof('0x4914025aa9ea9f274b174205adde3243eec74589bef9a0e78a433763b2f8caa3').then((result)=>{
      EP.storageRoot(result.path, result.value, result.stack, result.header, result.blockhash).should.be.true()
      new Error("not a tx. `get` should fail")
      (false).should.be.true("not a tx. `get` should fail")
      done()
    }).catch((e)=>{
...
describe('account state: codeHash proofs', function () {
  ...
  it('can request a contract proof from local chaindata', function (done) {
    eP.getCodeHashProof('9cc9bf39a84998089050a90087e597c26758685d').then((result)=>{
      EP.codeHash(result.address, result.value, result.stack, result.header, result.blockhash).should.be.true()
      done()
    }).catch((e) => {console.log(e)})
  });
  ...
  it('can request a proof from local chaindata', function (done) {
    eP.getCodeHashProof('0x4914025aa9ea9f274b174205adde3243eec74589bef9a0e78a433763b2f8caa3').then((result)=>{
      EP.codeHash(result.path, result.value, result.stack, result.header, result.blockhash).should.be.true()
      new Error("not a tx. `get` should fail")
      (false).should.be.true("not a tx. `get` should fail")
      done()
    }).catch((e)=>{
...
describe('account state,codeRoot, code proofs', function () {
  ...
  it('can request a contract proof from local chaindata', function (done) {
    eP.getCodeProof('9cc9bf39a84998089050a90087e597c26758685d').then((result)=>{
      EP.code(result.address, result.value, result.stack, result.header, result.blockhash).should.be.true()
      done()
    }).catch((e) => {console.log(e)})
  });
  ...
  it('can request a proof from local chaindata', function (done) {
    eP.getCodeProof('0x4914025aa9ea9f274b174205adde3243eec74589bef9a0e78a433763b2f8caa3').then((result)=>{
      EP.code(result.path, result.value, result.stack, result.header, result.blockhash).should.be.true()
      new Error("not a tx. `get` should fail")
      (false).should.be.true("not a tx. `get` should fail")
      done()
    }).catch((e)=>{
